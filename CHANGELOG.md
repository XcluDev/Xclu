...
#### 2022-05-10
- Neuroplay - добавлено рисование графиков и запрос информаци. Делаю детекцию моргания.

#### 2021-12-27
- В диалог добавления модуля добавлен флажок показа только реализованных модулей
  и для каждой категории теперь показывается число модулей в ней.
 
#### 2021-12-26
- В Project добавлен Watchdog, который закрывает приложение, если оно замедлило работу.
