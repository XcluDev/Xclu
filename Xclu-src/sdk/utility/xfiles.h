...
void xc_write_binary_file_relpath(const void *data, int n, QString file_name, bool append = false);
...
QByteArray xc_read_binary_file_relpath(QString file_name, int read_bytes = -1);
