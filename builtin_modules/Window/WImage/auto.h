...
bool was_changed_is_new_frame_link() { return was_changed("is_new_frame_link"); }
QString gets_is_new_frame_link() { return gets("is_new_frame_link"); }
QStringList get_strings_is_new_frame_link() { return get_strings("is_new_frame_link"); }
...
//Const Int W
//Width of image.
bool was_changed_w() { return was_changed("w"); }
int geti_w() { return geti("w"); }

//Const Int H
//Height of image.
bool was_changed_h() { return was_changed("h"); }
int geti_h() { return geti("h"); }
