...
XStruct *getstruct_color_image() { return get_struct_("color_image"); }
...
XStruct *getstruct_depth_image() { return get_struct_("depth_image"); }
...
XStruct *getstruct_ir_image() { return get_struct_("ir_image"); }
