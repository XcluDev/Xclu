...
XDict *getobj_color_image() { return get_object_("color_image"); }
...
XDict *getobj_depth_image() { return get_object_("depth_image"); }
...
XDict *getobj_ir_image() { return get_object_("ir_image"); }
