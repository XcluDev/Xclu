...
//---------------------------------------------------------------------
void XArray::allocate(QVector<quint32> dim, XArrayDataType data_type) {
    quint32 size = 1;
...
//---------------------------------------------------------------------
void XArray::allocate_1d(unsigned int size, XArrayDataType data_type) {
...
//---------------------------------------------------------------------
void XArray::allocate_image(int channels, int w, int h, XArrayDataType data_type) {
...
//---------------------------------------------------------------------
const QVector<quint32> &XArray::dim() const {
    return dim_;
}

//---------------------------------------------------------------------
int XArray::dims() const {
    return dims_;
}

//---------------------------------------------------------------------
int XArray::image_channels() const {
...
inline quint32 XArray::to_index(const QVector<quint32> &index_vec) const {
...
//---------------------------------------------------------------------
inline quint32 XArray::pixel_index(int channel, int x, int y) const {
...
//---------------------------------------------------------------------
void *XArray::pixel_pointer(int x, int y) { //для изображений
    return data_ptr_ + pixel_index(0,x,y) * elem_size_;
}

void const *XArray::pixel_pointer(int x, int y) const { //для изображений
    return data_ptr_ + pixel_index(0,x,y) * elem_size_;
}
